        ...
        <div className="col-12 col-md-6 mb-4">
            <div className={`card bg-${getStatusVariant(status.flag)} shadow`} style={{ width: "100%", borderWidth: "2px" }}>
                <div className="card-body text-white">
                    ...
                    <div className="mb-3" />
                    <a href={`http://${constants.BACKEND_IP}:${constants.BACKEND_PORT}/uploads/download/` + props.upload.name} className="btn btn-primary btn-sm shadow" download>Download</a> {/* TODO: trebuie neaparat sa vad cum sa folosesc proxy-ul pt file download */}
